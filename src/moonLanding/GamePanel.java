...
implements ActionListener, KeyListener, ComponentListener
{
	...
	public final ImageIcon CRAFT_ICON=new ImageIcon("img/craft.gif");
	public final ImageIcon CRAFT_DESTROYED_ICON=new ImageIcon("img/craft_destroyed.gif");
	public final ImageIcon BK_ICON=new ImageIcon("img/bk.gif");
	public final ImageIcon LAND_ICON=new ImageIcon("img/land.gif");
	public final ImageIcon FRAME_LEFT_ICON=new ImageIcon("img/frameLeft.gif");
	public final ImageIcon FRAME_RIGHT_ICON=new ImageIcon("img/frameRight.gif");
	public final ImageIcon FRAME_UP_ICON=new ImageIcon("img/frameUp.gif");
	public final ImageIcon FRAME_DOWN_ICON=new ImageIcon("img/frameDown.gif");
	public final ImageIcon MOUNTAIN_ICON=new ImageIcon("img/mountain.gif");
	...
	{
		endGame();
		craft_img=CRAFT_DESTROYED_ICON;		
		repaint();
	}
